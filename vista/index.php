...
<body>
    ...
    <header>
        ...
        <h1 style="font-size: 35px;
           margin: 20px 0 0 0; /* 20px de margen superior y 0 para los otros lados */
           display: flex; 
    ...
    <section id="services">
        ...
        <div class="services">
            <div>
                ...
                <a type="button" class="btn btn-outline-success" href="?i=paquetes1">Mas info...</a>
            </div>
            <div>
                <h3>Rutas Personalizadas</h3>
                <p>Creamos rutas a medida según tus preferencias y tiempo disponible.</p>
                <a type="button" class="btn btn-outline-success" href="?i=rutas1">Mas info...</a>
            </div>
            <div>
                ...
                <a type="button" class="btn btn-outline-success" href="?i=excursiones1">Mas info...</a>
            </div>
        </div>
    </section>
